...
function Testi() {
  ...
  const api_url = `https://external.api.yle.fi/v1/teletext/images/100/1.png?app_id=${app_id}&app_key=${app_key}`;

  const [items, setItems] = useState([]);
  const [uutinen6, setUutinen6] = useState("");
  const [uutinen9, setUutinen9] = useState("");
  ...
  */
  ...
  const getUutiset = () => {
    ...
    setUutinen6(uutiset1[5].Text)
    setUutinen9(uutiset1[8].Text)
  ...
  return (
    <div className="testiBody">
      <div>
        <h3>TEXT FORMAT NEWS HERE</h3>
        <p>{uutinen6}{uutinen9}</p>
      </div>
      ...
      <div className="bottom-container">
        ...
        <div className="news-image-border">
          <h1>Uutiset</h1>
          <p>Toinen tapa tuoda uutiset YLE API:n kautta on kuvana.<br />Tämä ei ole kuitenkaan yhtä suositeltavaa tietoturva syistä, <br />koska app_id ja app_key pitäisi saada piilotettua.</p>
          <img src={api_url} alt="" width="400px" height="auto" />
        </div>
      </div>
